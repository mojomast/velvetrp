...
export function buildEnemies(refs: StarterReferences) {
  ...
  const challengeRatingByTag: Readonly<Record<string, number>> = Object.freeze({ "cr-0": 0, "cr-1-8": 0.125, "cr-1-4": 0.25, "cr-1-2": 0.5 });
  const enemyTemplate = (
    ...
    return {
      ...
      mechanics: {
        tier: 1, challengeRating: challengeRatingByTag[crTag], maxHp, defense, speed,
