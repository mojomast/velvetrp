...
const yieldToEventLoop = () => new Promise<void>((resolve) => setTimeout(resolve, 0));
 ...
 type NarrationReceipt = { kind: "mechanic"; event: { type: string; data: unknown } } | { kind: "combat"; action: "attack"|"flee"|"end-turn"|"dash"|"grapple"|"escape-grapple"|"shove"|"stand-up"|"disengage"|"help"|"hide"|"stabilize"|"death-save";
