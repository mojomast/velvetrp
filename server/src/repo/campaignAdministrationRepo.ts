...
import { createAdministrationExportRepo } from "./campaignAdmin/administrationExportRepo.js";
...
export function createCampaignAdministrationRepository(db: DatabaseDriver.Database,
  ...
  const exports = createAdministrationExportRepo({ db, deps, runMutation: commands.runMutation, events, receipts });
