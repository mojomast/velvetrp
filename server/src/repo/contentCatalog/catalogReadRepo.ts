...
interface PublicationRow { pack_id: string; pack_version: string; name: string; description: string; tags: string; rules_profile_id: string; rules_engine: string; manifest_digest: string; manifest_json: string; provenance_json: string; validation_report_json: string; published_at: string; definition_count: number; definition_counts_json: string; publication_digest: string; public_projection_digest: string; public_projection_count: number; }
