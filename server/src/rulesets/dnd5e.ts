...
const capabilityVersions: Readonly<Record<string, string>> = Object.freeze({ attacks: "1.5.0", conditions: "1.1.0", damage: "1.2.0", movement: "1.2.0", rests: "1.1.0", "spell-costs": "1.2.0" });
