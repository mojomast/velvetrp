...
describe("schema", () => {
  it("records the fresh v45r1 schema, current inventory, and foreign-key integrity", async () => {
    ...
    ) OR name GLOB '*v43*' OR name GLOB '*v45*') ORDER BY name`).all()).toEqual([
