...
import { magicRings } from "../src/content/srdStarter/magicItems/rings.js";
...
describe("SRD 5.1 rings", () => {
  ...
  it("carries magic-item mechanics and category tags on every definition", () => {
    for (const definition of parsed) {
      ...
      expect(definition.mechanics.slot).toBe("accessory");
      expect(definition.tags).toContain("srd-5.1");
      expect(definition.tags).toContain("magic-item");
      expect(definition.tags).toContain("ring");
    }
  });
