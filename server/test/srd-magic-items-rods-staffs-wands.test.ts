...
import { magicRodsStaffsWands } from "../src/content/srdStarter/magicItems/rods-staffs-wands.js";
...
const items = magicRodsStaffsWands(refs);
const parsed = items.map((item) => itemCatalogDefinitionSchema.parse(item));

describe("SRD 5.1 rods, staffs, and wands", () => {
