...
import { cr17To20Band } from "../src/content/srdStarter/monsters/cr-17-20.js";
import { createStarterReferences } from "../src/content/srdStarter/references.js";

const refs = createStarterReferences("1.6.0+test");
const { abilities, enemies } = cr17To20Band(refs);

describe("SRD 5.1 monsters of challenge rating 17 through 20", () => {
  it("provides a bounded band of at least twelve CR-17 through CR-20 enemy templates", () => {
  ...
  it("gives every enemy a combat profile", () => {
    for (const enemy of enemies) {
