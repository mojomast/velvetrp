...
export const MEMORY_EVAL_DEVELOPMENT_CASES: readonly MemoryEvalCase[] = [
  ...
  { id: "quest-hydration-v1", category: "outcome", query: "public quest receipt", actor: "aster", requiredSourceKeys: ["quest:hydration"], forbiddenSourceKeys: [], supportedFacts: ["The public objective has one committed quest receipt."], forbiddenInferences: ["A quest receipt exposes private candidate identity."], baseline: "supported" },
  { id: "travel-hydration-v1", category: "outcome", query: "memory destination", actor: "aster", requiredSourceKeys: ["travel:hydration"], forbiddenSourceKeys: [], supportedFacts: ["The public route has one committed travel receipt."], forbiddenInferences: ["A travel receipt exposes private route binding identity."], baseline: "supported" },
