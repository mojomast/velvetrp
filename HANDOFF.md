...
## Next Task: M2.7 economy and rest routes
...
The v29 character-layout digest is `bcca64e4206ed0db503cbea137334ae9f92fa6050537e3a950630b00b37bc25d`. M1.9 quests, storylines, clues, rewards, and objective completions is complete in schema v29r2. The quest bootstrap, M2.1-M2.3, and M2.5 content catalog routes are complete. M2.4 exposes a stateless, no-write import dry-run route; durable import apply and export remain pending. M2.6 character creation, sheet, XP, preview, and token-bound level application routes are complete. M2.7 actor-resource and constrained inventory routes are complete; economy and rest remain pending.
