...
Repository refactor progress: `db.ts` migration modules and the initial campaign dependency, dice-command, core, actor-projection, and administration adapter slices have been extracted behind compatibility facades. Public repository APIs, SQL, trigger logic, and migration order remain unchanged.
