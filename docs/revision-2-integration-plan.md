...
- **Migration window at this saved revision:** the board proposed canonical populated `N-2` and `N-1` support. The current v53 policy instead preserves every already accepted populated v46-v52 input; [operations.md](operations.md) is authoritative.
