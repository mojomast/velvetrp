...
- [System One (Jev) guardrails benchmark](system-one-guardrails-benchmark.md) - Generated live evaluation of the L6 advisory guardrail lane over a labeled hazard corpus, with the confusion matrix, false-positive analysis, calibration, and the (not ready) strict-gate verdict.
