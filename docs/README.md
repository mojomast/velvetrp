...
- [Jev (TypeSafe System One) integration](jev-integration.md) - Researched, unimplemented integration spec for an optional typed-decision provider lane (choice/score/noul) with confidence-gated routing, deterministic fallback, and evaluation; planning only.
