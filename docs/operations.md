...
The current trusted-local RPG boundary has 130 counted explicit operations, excluding feature discovery and implicit HEAD; this supersedes the historical count above.
