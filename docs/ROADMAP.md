...
- **Current baseline:** one disposable development schema with delete/recreate changes; 130 counted operations plus feature discovery. Live exact-candidate generation/selection HTTP and client selection remain absent. Existing manual travel remains separate. The protected catalog is unchanged.
