...
**Progress: Started. Quest bootstrap routes, M2.1-M2.3, and M2.5 are complete; M2.4 import dry-run is complete while durable apply/export remains pending. M2.6 draft finalization is complete while sheet, XP, and level routes remain pending.**
