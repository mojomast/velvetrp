...
import { generationDraftApplyRequestSchema, generationDraftCreateRequestSchema, generationDraftGetResponseSchema } from "../src/generation-drafts-http.js";
...
describe("M2.11 generation draft HTTP contracts", () => {
  ...
  it("requires explicit fallback provenance", () => {
    ...
    const response = { draft: { draftId: "draft", campaignId: "campaign", kind: "npc", state: "staged", revision: 0, createdAt: at, updatedAt: at },
      provenance: { source: "user-brief", method: "deterministic-fallback" },
